...
![Venture Pulse Architecture](./gemini_generated_architecure_diagram.png)
...
* **AI Agent (OpenAI/Gemini)**: Integrated into the backend to transform natural language queries into SQL or data insights, allowing users to "talk" to their portfolio data.
